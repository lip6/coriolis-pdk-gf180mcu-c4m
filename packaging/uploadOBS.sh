 ...
 for distribFile in packaging/coriolis-pdk-gf180mcu-c4m.spec      \
                    packaging/coriolis-pdk-gf180mcu-c4m-rpmlintrc \
                    packaging/patchvenv.sh                         \
                    ${venvSnapshot}                                \
                    coriolis-pdk-gf180mcu-c4m-${version}.tar.gz   \
                    packaging/coriolis-pdk-gf180mcu-c4m.dsc       \
                    packaging/coriolis-pdk-gf180mcu-c4m-rpmlintrc \
 ...
 sed -i "s,^Release: *1,Release:        <CI_CNT>.<B_CNT>.${githash}," ${obsDir}/coriolis-pdk-gf180mcu-c4m.spec
